$(function() {
  ...
  $('#buttonLabel').click(function(){
    ...
    $('#buttonLabel, #buttonZone, #buttonBouton').prop("disabled", true); // on désactive les boutons lable, zone de texte et bouton
    $('#okLabel').click(function(){
      $('#gauche').append('<span><strong>' + $('#idLabel').val() + '</strong></span>');
      $('span').append('   ');
      $('#buttonLabel, #buttonZone, #buttonBouton').prop("disabled", false); // on réactive les boutons lable, zone de texte et bouton
